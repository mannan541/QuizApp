...
import com.android.tutorial.retrofit.RedditAPI;
import com.android.tutorial.retrofit.model.Feed;
import com.android.tutorial.retrofit.model.children.Children;
...
public class RetrofitSignupActivity extends AppCompatActivity {

    private static final String TAG = RetrofitSignupActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retrofit_signup);
            ...
            public void onClick(View v) {
                ...
                call.enqueue(new Callback<ResponseBody>() {
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable t) {
                        ...
                        Toast.makeText(RetrofitSignupActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
