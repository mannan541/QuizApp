...
import com.android.tutorial.services.StopwatchService;

/**
 * Created by Mannan on 1/19/2017.
 */
...
public class StopwatchActivity extends ListActivity {
    ...
    private ArrayAdapter<String> m_lapListAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        m_lapListAdapter = (ArrayAdapter<String>) getListAdapter();
    ...
    public void onLapClicked(View v) {
        ...
        m_lapListAdapter.insert(m_stopwatchService.getFormattedElapsedTime(), 0);
    }
