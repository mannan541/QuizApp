...
import com.android.tutorial.utils.Utils;
import com.bumptech.glide.Glide;
import com.bumptech.glide.load.engine.DiskCacheStrategy;

public class WebViewInAppBrowserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_web_view_in_app_browser);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (Utils.isSameDomain(postUrl, url)) {
                    Intent intent = new Intent(WebViewInAppBrowserActivity.this, WebViewInAppBrowserActivity.class);
    ...
    private void openInAppBrowser(String url) {
        Intent intent = new Intent(WebViewInAppBrowserActivity.this, BrowserActivity.class);
