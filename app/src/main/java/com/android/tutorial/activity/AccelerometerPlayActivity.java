...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    class SimulationView extends View implements SensorEventListener {
        ...
        public SimulationView(Context context) {
            ...
            Bitmap ball = BitmapFactory.decodeResource(getResources(), R.drawable.aar_ic_check);
            ...
            mWood = BitmapFactory.decodeResource(getResources(), R.drawable.aar_ic_clear, opts);
        }
